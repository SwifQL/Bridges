...
public class UpdateEnumBuilder<Enum: BridgesEnum> where Enum.RawValue == String {
    ...
    public func add(_ value: String) -> Self {
        actions.append(SwifQL.alter.type(Enum.name).add.value[any: value].semicolon)
        return self
    }
    
    public func add(_ value: String, before v: String) -> Self {
        actions.append(SwifQL.alter.type(Enum.name).add.value[any: value].before[any: v].semicolon)
        return self
    }
    
    public func add(_ value: String, after v: String) -> Self {
        actions.append(SwifQL.alter.type(Enum.name).add.value[any: value].after[any: v].semicolon)
        return self
    }
